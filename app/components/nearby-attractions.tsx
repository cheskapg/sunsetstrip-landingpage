...
export default function NearbyAttractions() {
  const attractions = [
    ...
    },
    {
      ...
      distance: "55km",
      type: "Marine Life",
      directionsUrl: "https://maps.google.com/?q=Oslob+Whale+Shark+Watching+Cebu"
    },
    {
      name: "Cambais Falls",
      time: "19 minutes",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover amazing adventures and natural wonders just minutes away from Sunset Strip. 
            From thrilling canyoneering to serene waterfalls.
          </p>
        </div>
          ...
          {attractions.map((attraction, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getTypeColor(attraction.type)}`}>
                  {attraction.type}
                </span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-600">
                  ...
                  <span className="text-sm font-medium">{attraction.time} away</span>
                </div>
                
                <div className="flex items-center text-gray-600">
                  <MapPinIcon className="h-5 w-5 text-orange-500 mr-3" />
                  <span className="text-sm font-medium">{attraction.distance} distance</span>
                </div>
              </div>
